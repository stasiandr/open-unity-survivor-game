...
namespace InventorySystem
{
    ...
    public class InventoryItemGameObject : InventoryItemBase
    {
        ...
        public InventoryItemGameObject(IInventoryItemDescriptorBase descriptor, int level, GameObject gameObject) :
    ...
    public class InventoryItem : InventoryItemBase
    {
        ...
        public InventoryItem(IInventoryItemDescriptorBase descriptor, int level, IDisposable disposable) : base(
            descriptor, level)
        {
