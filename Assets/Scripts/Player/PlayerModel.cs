...
namespace Player
{
    ...
    public class PlayerModel
    {
        ...
        public FloatReactiveProperty IntervalDecrease { get; private set; } = new(0);
        ...
        {
            _currentTotalExperience.Value += experience;
        }

        public void AddMaxHealth(int additionMaxHealth)
        {
            _maxHealth.Value += additionMaxHealth;
        }

        public void RemoveMaxHealth(int additionMaxHealth)
        {
            _maxHealth.Value -= additionMaxHealth;
        }
        ...
        public void InjectPlayerStats(ref object target)
        {
            ...
            if (target is IProjectileSpeed pps)
